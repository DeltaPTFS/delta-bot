...
SUPPORT_UNAVAILABLE_MESSAGE = SUPPORT_FORMATS["unavailable"]
...
## What's Fixed
- Moved all long support-format messages into validated JSON data.
- Removed fragile multiline Python literals that could break Render startup.
- Kept all 13 anonymous, branded notices in the single `/format` picker.
