...
SUPPORT_FORMAT_LABELS: dict[str, str] = {
    ...
    "skymiles": "Welcome to SkyMiles",
    "inactive": "Inactive Inquiry",
    "resolved": "Inquiry Resolved",
    "partnership_denied": "Partnership Denied",
    "partnership_accepted": "Partnership Accepted",
    "direct_entry": "Direct Entry Application",
...
SUPPORT_FORMATS: dict[str, str] = {
    ...
    "unavailable": SUPPORT_UNAVAILABLE_MESSAGE,
    "skymiles": """## <:WingPinLogo:1540927847709802607> **Welcome to SkyMiles!**
...
-# Welcome to SkyMiles!""",
    "inactive": """<:Timer:1540927345324728400> **It seems your inquiry has been inactive.**
...
-# Thank you for contacting Delta Support.""",
    "resolved": """<:Support:1540927430179553321> **It seems your inquiry has been resolved.**
...
-# Thank you for contacting Delta Support.""",
    "partnership_denied": """<:Support:1540927430179553321> **Your Partnership Status has been updated.**
...
-# Thank you for choosing Delta Air Lines.""",
    "partnership_accepted": """<:Support:1540927430179553321> **Your Partnership Status has been updated.**
...
-# 1020 Delta Blvd., Suite 996, Atlanta, GA 30354.
-# Thank you for partnering with Delta Air Lines.""",
    "direct_entry": """<:Support:1540927430179553321> **Direct Entry Application**
...
-# Thank you for choosing Delta Air Lines.""",
    "application_submitted": """<:Support:1540927430179553321> **Your application has been officially submitted.**

-# P.O. Box 20980 Department 980 Atlanta, GA 30320-2980.

> <:WingPinLogo:1540927847709802607> **Thank you,** for taking the time to fill out an application. It has currently been submitted to our **Recruitment - Talent Department,** where it will be reviewed and an update will be provided shortly!""",
    "application_accepted": """<:Support:1540927430179553321> **Your Application Status has been updated.**
...
-# Thank you for choosing Delta Air Lines.""",
    "application_denied": """<:Support:1540927430179553321> **Your Application Status has been updated.**
...
-# Thank you for choosing Delta.""",
    "leadership": """<:Support:1540927430179553321> **Leadership Application**
...
> <:BArrow:1540951845147639809> **Talent Acquisition Officer -** [AVAL]""",
    "hr": """<:Support:1540927430179553321> **HR Application**
...
## What's Fixed
- Fixed the support-format definition syntax that prevented Render from starting the bot.
- Kept all canned notices available through the single `/format` picker.
- Customer-facing notices remain anonymous and identical to the ticket record.
